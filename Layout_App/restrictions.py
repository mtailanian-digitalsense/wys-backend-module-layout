...
set_mod2area_val('WYS_SOPORTE_KITCHENETTE', [0, 0, 0, 1, 0])
...
set_mod2mod_matrix_value(module_dictionary, mod2mod_matrix, 'WYS_SOPORTE_PRINT1', 'WYS_SOPORTE_PRINT1', -0.25)
